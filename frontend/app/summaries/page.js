...
export default function SummariesPage() {
  ...
  const fetchSummaries = async (params = {}) => {
    try {
      ...
      // Calculate stats from filtered summaries
      ...
      const avgWords = filteredSummaries.length > 0 
        ? Math.round(filteredSummaries.reduce((acc, s) => acc + s.wordCount, 0) / filteredSummaries.length)
        : 0;
    ...
    <div className="min-h-screen bg-[#0A0A0A]">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button className="border border-[#10B981] text-[#10B981] px-6 py-3 rounded font-normal transition-all duration-200 hover:border-[#059669] hover:text-[#059669] hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(16,185,129,0.4)] flex items-center gap-2">
        ...
        <div className="flex flex-col lg:flex-row gap-4 mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <option value="style" className="bg-[#0A0A0A]">Summary Style</option>
              <option value="language" className="bg-[#0A0A0A]">Language</option>
            </select>
        ...
        {loading ? (
          ...
          <div className="border border-[#1F2937] rounded-lg p-12 text-center">
            ...
            <button className="border border-[#10B981] text-[#10B981] px-6 py-3 rounded font-normal transition-all duration-200 hover:border-[#059669] hover:text-[#059669] hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(16,185,129,0.4)] flex items-center gap-2 mx-auto">
              <Plus className="w-4 h-4 stroke-1.5" />
              Generate Summary
            </button>
          </div>
